        ...
        <div className="hidden lg:flex lg:w-1/2 relative neural-bg flex-col justify-end p-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              AI-Powered Reports <br />
              <span className="text-blue-400">from Your Data</span>
            </h2>
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Unlock insights hidden in your numbers with our advanced neural networks. Transform raw data into actionable strategies instantly.
            </p>
            <div className="flex items-center space-x-2">
          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Welcome back to SWIXREPORT dashboard.
              </p>
            </div>
            <form onSubmit={onSubmit} className="mt-8 space-y-6">
              ...
              <div className="flex items-center justify-end">
                <div className="text-sm">
                  <Link href="#" className="font-medium text-primary hover:text-primary/90 transition-colors">
                    Forgot password?
                  </Link>
                </div>
              </div>
            ...
            <div className="relative mt-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-surface-light dark:bg-surface-dark px-2 text-muted-foreground">Or continue with</span>
              </div>
            </div>
            <div className="mt-6">
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/signup" className="font-medium text-primary hover:text-primary/90 ml-1 transition-colors">Sign Up</Link>
            </div>
          </div>
        </div>
      </div>
